    ...
    <div className="flex relative bg-slate-100">
      ...
      <div className="bg-white mt-3 mx-auto border rounded-md shadow-2xl text-center flex">
        <div className="flex-1 rounded">
          <h2 className="text-3xl p-1 font-semibold mb-5 bg-blue-500 pt text-white shadow rounded-t-md ">
            Saida
          </h2>
          {isLoadingBills ? (
            ...
            <div className="p-4">
              <div>
                <div className="shadow-lg rounded">
                  <h1 className="text-3xl text-blue-500 font-medium rounded-t ">
                    Nova Saida
                  </h1>
                  <form className="p-4 bg-white rounded-lg flex space-x-4 items-center">
                    <div className="flex-1">
                      <label
                        htmlFor="date-input"
                        className="block rounded-t-lg bg-blue-500 text-lg font-semibold text-white"
                      >
                        {" "}
                        Data:
                      </label>
                    ...
                    <button
                      className="bg-blue-500 text-white px-4 text-xl py-3 rounded-lg focus:outline-none focus:ring focus:ring-blue-300"
                      style={{ height: "50px" }}
                      type="submit"
                ...
                <div className="relative overflow-x-auto shadow-xl text-center sm:rounded-lg mt-5 pb-4">
                  <table className="w-full text-sm text-left text-gray-500 text-center dark:text-gray-400">
                    <thead className=" text-white uppercase bg-blue-500 text-center">
                      <tr>
